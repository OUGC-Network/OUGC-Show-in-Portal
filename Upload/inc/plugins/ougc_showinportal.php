...
if (defined('IN_ADMINCP')) {
    ...
    \ougc\ShowInPortal\Core\addHooks('ougc\ShowInPortal\Hooks\Admin');
} else {
    require_once OUGC_SHOWINPORTAL_ROOT . '/Hooks/Forum.php';

    \ougc\ShowInPortal\Core\addHooks('ougc\ShowInPortal\Hooks\Forum');
}
...
{
    return \ougc\ShowInPortal\Admin\pluginInfo();
}

function ougc_showinportal_activate(): bool
{
    return \ougc\ShowInPortal\Admin\pluginActivate();
}

// _is_installed() routine
function ougc_showinportal_is_installed(): bool
{
    return \ougc\ShowInPortal\Admin\pluginIsInstalled();
}

// _uninstall() routine
function ougc_showinportal_uninstall(): bool
{
    return \ougc\ShowInPortal\Admin\pluginUninstall();
}
